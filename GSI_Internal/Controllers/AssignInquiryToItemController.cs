    ...
    public class AssignInquiryToItemController : Controller
    {
        ...
        public IActionResult AddAssignInquiryToItem(int? Id)
        {
            ...
            if (Id.HasValue)
            {
                ...
                teacher.AssignInquiryToItems.ToList().ForEach(result => subjectsIds.Add(result.InquiryID));
        ...
        public IActionResult AddAssignInquiryToItem(drpInquiry model)
        {
            ...
            if (model.Id > 0)
            {
                ...
                teacher.AssignInquiryToItems.ToList().ForEach(result => teacherSubjects.Add(result));
              ...
              //  teacher.TransactionNameArabic = model.Name;
                if (model.InquirysIds != null)
                {
                    ...
                    teacher.AssignInquiryToItems = teacherSubjects;
                }
                Db.SaveChanges();
