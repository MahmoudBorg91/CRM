using CairoZoom.Core;
using CairoZoom.Core.Entity.ApplicationData;
using CairoZoom.Core.Entity.ChatAndNotification;
...
namespace GSI_Internal.BusinessLayer.SignalR
{
    //  [Authorize]
